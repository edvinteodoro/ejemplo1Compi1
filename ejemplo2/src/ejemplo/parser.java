...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Mon Feb 10 02:06:12 CST 2020
  */
public class parser extends java_cup.runtime.lr_parser {
  ...
  protected static final short[][] _action_table = 
    unpackFromStrings(new String[] {
    "\000\021\000\010\003\005\010\007\012\004\001\002\000" +
    "\016\002\ufffa\004\ufffa\005\ufffa\006\ufffa\007\ufffa\011\ufffa" +
    "\001\002\000\016\002\ufff9\004\ufff9\005\ufff9\006\ufff9\007" +
    "\ufff9\011\ufff9\001\002\000\004\002\023\001\002\000\010" +
    "\003\005\010\007\012\004\001\002\000\014\002\000\004" +
    "\011\005\012\006\014\007\013\001\002\000\010\003\005" +
    "\010\007\012\004\001\002\000\010\003\005\010\007\012" +
    "\004\001\002\000\010\003\005\010\007\012\004\001\002" +
    "\000\010\003\005\010\007\012\004\001\002\000\016\002" +
    "\ufffd\004\ufffd\005\ufffd\006\ufffd\007\ufffd\011\ufffd\001\002" +
    "\000\016\002\ufffc\004\ufffc\005\ufffc\006\ufffc\007\ufffc\011" +
    "\ufffc\001\002\000\016\002\ufffe\004\ufffe\005\ufffe\006\014" +
    "\007\013\011\ufffe\001\002\000\016\002\uffff\004\uffff\005" +
    "\uffff\006\014\007\013\011\uffff\001\002\000\014\004\011" +
    "\005\012\006\014\007\013\011\022\001\002\000\016\002" +
    "\ufffb\004\ufffb\005\ufffb\006\ufffb\007\ufffb\011\ufffb\001\002" +
  ...
  protected static final short[][] _reduce_table = 
    unpackFromStrings(new String[] {
    "\000\021\000\006\002\005\003\007\001\001\000\002\001" +
    "\001\000\002\001\001\000\002\001\001\000\004\003\020" +
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$parser$act_num)
		...
		System.out.println(" NUM: "+e+"\n"); RESULT=e;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 6: // operacion ::= PARA operacion PARC 
            {
              Integer RESULT =null;
		...
		System.out.println(" OP: ("+e+")\n"); RESULT=e;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 5: // operacion ::= operacion DIV operacion 
            {
              Integer RESULT =null;
		...
		int eright = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).right;
		Integer e = (Integer)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		System.out.println(" OP: "+a+"/"+e+"\n"); RESULT=a/e;
              CUP$parser$result = parser.getSymbolFactory().newSymbol("operacion",1, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 4: // operacion ::= operacion POR operacion 
            {
              Integer RESULT =null;
		int aleft = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)).left;
		int aright = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)).right;
		...
		System.out.println(" OP: "+a+"*"+e+"\n"); RESULT=a*e;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 3: // operacion ::= operacion MENOS operacion 
            {
              Integer RESULT =null;
		int aleft = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)).left;
		int aright = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)).right;
		...
		System.out.println(" OP: "+a+"-"+e+"\n"); RESULT=a-e;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 2: // operacion ::= operacion MAS operacion 
            {
              Integer RESULT =null;
		int aleft = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)).left;
		int aright = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)).right;
